...
#### 💡 @everyone通知
説明欄の**一番最初に**`@everyone`と入力すると、3日前と当日の朝5:00にDiscordに`@everyone`で通知されます。
...
予定の登録・修正時の説明欄の**一番最初に**`@everyone`と入力する。
...
**対処法**：
- カレンダー管理パネルの「カレンダーを開く」で直接Googleカレンダーを表示し、予定のイベントIDや登録者（自分かどうか）を確認してください。
...
**確認事項**：
- @everyone通知の通知タイミングは、**予定3日前と当日の朝5:00**です。
- カレンダー管理パネルの「カレンダーを開く」で直接Googleカレンダーを表示し、予定の日時や説明欄を確認してください。
